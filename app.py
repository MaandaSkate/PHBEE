...
def display_message(sender, message):
    user_icon_base64 = img_to_base64("assets/PHBEE USER ICON.png")
    logo_base64 = img_to_base64("assets/PHBEE LOGO FINAL.png")
    ...
    if sender == "user":
        st.markdown(
            ...
            f'{message}</div>'
            f'<img src="data:image/png;base64,{user_icon_base64}" '
